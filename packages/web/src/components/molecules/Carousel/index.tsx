...
export const Carousel = ({ slides, circle = false }: CarouselProps) => {
      ...
      >
        {slides.map(({ title, text }, index) => (
          <li
            ...
            key={index}
          >
            <TransparentWrapper additionalClasses="slide-center relative w-[clamp(276px,50vw,520px)]">
              {circle && (
                <Circle index={index + 1} classNames="mb-5 fill-white20" />
              )}
